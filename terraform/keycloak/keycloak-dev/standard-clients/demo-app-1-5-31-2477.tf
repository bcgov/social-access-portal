...
module "demo-app-1-5-31-2477-bcsc-idp" {
  source      = "github.com/bcgov/social-access-portal-terraform-modules?ref=5209238/modules/bcsc-idp"
  realm_id    = outputs.bcsc_realm_id
  client_name = "demo-app-1-5-31-2477"
  valid_redirect_uris = [
    "https://demo-app-1.apps.silver.devops.gov.bc.ca/*",
    "http://localhost:3002"
