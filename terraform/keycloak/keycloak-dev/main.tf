...
module "standard" {
  source       = "github.com/bcgov/social-access-portal-terraform-modules?ref=e3ae0cd/modules/base-realms/realm-standard"
...
module "idir" {
  source                     = "github.com/bcgov/social-access-portal-terraform-modules?ref=e3ae0cd/modules/base-realms/realm-idir"
  keycloak_url               = var.keycloak_url
...
module "azureidir" {
  source                 = "github.com/bcgov/social-access-portal-terraform-modules?ref=e3ae0cd/modules/base-realms/realm-azureidir"
  keycloak_url           = var.keycloak_url
...
module "bcsc" {
  source                 = "github.com/bcgov/social-access-portal-terraform-modules?ref=e3ae0cd/modules/base-realms/realm-bcsc"
  keycloak_url           = var.keycloak_url
...
module "bceidbasic" {
  source                     = "github.com/bcgov/social-access-portal-terraform-modules?ref=e3ae0cd/modules/base-realms/realm-bceidbasic"
  keycloak_url               = var.keycloak_url
...
module "bceidbusiness" {
  source                     = "github.com/bcgov/social-access-portal-terraform-modules?ref=e3ae0cd/modules/base-realms/realm-bceidbusiness"
  keycloak_url               = var.keycloak_url
...
module "bceidboth" {
  source                     = "github.com/bcgov/social-access-portal-terraform-modules?ref=e3ae0cd/modules/base-realms/realm-bceidboth"
  keycloak_url               = var.keycloak_url
...
module "master_idir_link" {
  source           = "github.com/bcgov/social-access-portal-terraform-modules?ref=e3ae0cd/modules/master-idp-link"
  keycloak_url     = var.keycloak_url
...
module "master_viewer_role" {
  source      = "github.com/bcgov/social-access-portal-terraform-modules?ref=e3ae0cd/modules/master-viewer-role"
